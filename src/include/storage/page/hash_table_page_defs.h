...
/** BUCKET_ARRAY_SIZE is the number of (key, value) pairs that can be stored in a bucket page.
 ...
 * to maintain the occupied and readable flags for a key value pair, and we need 4 bytes in the page to store local
 * depth
 */
