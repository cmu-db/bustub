...
class TrieNode {
 public:
  ...
  virtual auto CloneWithMap(std::map<char, std::shared_ptr<const TrieNode>> children) const
      -> std::shared_ptr<TrieNode> {
    return std::make_shared<TrieNode>(std::move(children));
  }
...
class TrieNodeWithValue : public TrieNode {
 public:
  ...
  auto CloneWithMap(std::map<char, std::shared_ptr<const TrieNode>> children) const
      -> std::shared_ptr<TrieNode> override {
    return std::make_shared<TrieNodeWithValue>(children, value_);
  }
