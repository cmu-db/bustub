...
static constexpr int INVALID_PAGE_ID = 1;                                    // representing an invalid page id
static constexpr int INVALID_TXN_ID = -1;                                    // representing an invalid transaction id
static constexpr int INVALID_LSN = -1;                                       // representing an invalid log sequence number
