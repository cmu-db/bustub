...
test/CMakeFiles/clock_replacer_test.dir/buffer/clock_replacer_test.cpp.o: ../test/buffer/clock_replacer_test.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/bustub/_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/clock_replacer_test.dir/buffer/clock_replacer_test.cpp.o"
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/clock_replacer_test.dir/buffer/clock_replacer_test.cpp.o -c /tmp/bustub/test/buffer/clock_replacer_test.cpp
...
test/CMakeFiles/clock_replacer_test.dir/buffer/clock_replacer_test.cpp.i: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/bustub/test/buffer/clock_replacer_test.cpp > CMakeFiles/clock_replacer_test.dir/buffer/clock_replacer_test.cpp.i
...
test/CMakeFiles/clock_replacer_test.dir/buffer/clock_replacer_test.cpp.s: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/bustub/test/buffer/clock_replacer_test.cpp -o CMakeFiles/clock_replacer_test.dir/buffer/clock_replacer_test.cpp.s
...
test/CMakeFiles/clock_replacer_test.dir/__/tools/backtrace.cpp.o: ../tools/backtrace.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/bustub/_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object test/CMakeFiles/clock_replacer_test.dir/__/tools/backtrace.cpp.o"
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/clock_replacer_test.dir/__/tools/backtrace.cpp.o -c /tmp/bustub/tools/backtrace.cpp
...
test/CMakeFiles/clock_replacer_test.dir/__/tools/backtrace.cpp.i: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/bustub/tools/backtrace.cpp > CMakeFiles/clock_replacer_test.dir/__/tools/backtrace.cpp.i
...
test/CMakeFiles/clock_replacer_test.dir/__/tools/backtrace.cpp.s: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/bustub/tools/backtrace.cpp -o CMakeFiles/clock_replacer_test.dir/__/tools/backtrace.cpp.s
...
test/clock_replacer_test: test/CMakeFiles/clock_replacer_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/bustub/_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX executable clock_replacer_test"
	cd /tmp/bustub/_build/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/clock_replacer_test.dir/link.txt --verbose=$(VERBOSE)
	cd /tmp/bustub/_build/test && /usr/bin/cmake -D TEST_TARGET=clock_replacer_test -D TEST_EXECUTABLE=/tmp/bustub/_build/test/clock_replacer_test -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/tmp/bustub/_build/test -D "TEST_EXTRA_ARGS=--gtest_output=xml:/tmp/bustub/_build/test/clock_replacer_test.xml;--gtest_catch_exceptions=0" -D "TEST_PROPERTIES=TIMEOUT;120" -D TEST_PREFIX= -D TEST_SUFFIX= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=clock_replacer_test_TESTS -D CTEST_FILE=/tmp/bustub/_build/test/clock_replacer_test[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=120 -D TEST_XML_OUTPUT_DIR= -P /usr/share/cmake-3.18/Modules/GoogleTestAddTests.cmake
...
test/CMakeFiles/clock_replacer_test.dir/clean:
	cd /tmp/bustub/_build/test && $(CMAKE_COMMAND) -P CMakeFiles/clock_replacer_test.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/clock_replacer_test.dir/clean

test/CMakeFiles/clock_replacer_test.dir/depend:
	cd /tmp/bustub/_build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/bustub /tmp/bustub/test /tmp/bustub/_build /tmp/bustub/_build/test /tmp/bustub/_build/test/CMakeFiles/clock_replacer_test.dir/DependInfo.cmake --color=$(COLOR)
