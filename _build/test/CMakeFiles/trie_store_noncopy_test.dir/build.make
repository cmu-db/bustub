...
test/CMakeFiles/trie_store_noncopy_test.dir/primer/trie_store_noncopy_test.cpp.o: ../test/primer/trie_store_noncopy_test.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/bustub/_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/trie_store_noncopy_test.dir/primer/trie_store_noncopy_test.cpp.o"
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/trie_store_noncopy_test.dir/primer/trie_store_noncopy_test.cpp.o -c /tmp/bustub/test/primer/trie_store_noncopy_test.cpp
...
test/CMakeFiles/trie_store_noncopy_test.dir/primer/trie_store_noncopy_test.cpp.i: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/bustub/test/primer/trie_store_noncopy_test.cpp > CMakeFiles/trie_store_noncopy_test.dir/primer/trie_store_noncopy_test.cpp.i
...
test/CMakeFiles/trie_store_noncopy_test.dir/primer/trie_store_noncopy_test.cpp.s: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/bustub/test/primer/trie_store_noncopy_test.cpp -o CMakeFiles/trie_store_noncopy_test.dir/primer/trie_store_noncopy_test.cpp.s
...
test/CMakeFiles/trie_store_noncopy_test.dir/__/tools/backtrace.cpp.o: ../tools/backtrace.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/bustub/_build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object test/CMakeFiles/trie_store_noncopy_test.dir/__/tools/backtrace.cpp.o"
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/trie_store_noncopy_test.dir/__/tools/backtrace.cpp.o -c /tmp/bustub/tools/backtrace.cpp
...
test/CMakeFiles/trie_store_noncopy_test.dir/__/tools/backtrace.cpp.i: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/bustub/tools/backtrace.cpp > CMakeFiles/trie_store_noncopy_test.dir/__/tools/backtrace.cpp.i
...
test/CMakeFiles/trie_store_noncopy_test.dir/__/tools/backtrace.cpp.s: cmake_force
	...
	cd /tmp/bustub/_build/test && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/bustub/tools/backtrace.cpp -o CMakeFiles/trie_store_noncopy_test.dir/__/tools/backtrace.cpp.s
...
test/CMakeFiles/trie_store_noncopy_test.dir/clean:
	cd /tmp/bustub/_build/test && $(CMAKE_COMMAND) -P CMakeFiles/trie_store_noncopy_test.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/trie_store_noncopy_test.dir/clean

test/CMakeFiles/trie_store_noncopy_test.dir/depend:
	cd /tmp/bustub/_build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/bustub /tmp/bustub/test /tmp/bustub/_build /tmp/bustub/_build/test /tmp/bustub/_build/test/CMakeFiles/trie_store_noncopy_test.dir/DependInfo.cmake --color=$(COLOR)
