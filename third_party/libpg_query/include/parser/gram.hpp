...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    VACUUM = 697,                  /* VACUUM  */
    VALID = 698,                   /* VALID  */
    VALIDATE = 699,                /* VALIDATE  */
    VALIDATOR = 700,               /* VALIDATOR  */
    VALUE_P = 701,                 /* VALUE_P  */
    VALUES = 702,                  /* VALUES  */
    VARCHAR = 703,                 /* VARCHAR  */
    VARIADIC = 704,                /* VARIADIC  */
    VARYING = 705,                 /* VARYING  */
    VERBOSE = 706,                 /* VERBOSE  */
    ...
    VIEWS = 709,                   /* VIEWS  */
    VIRTUAL = 710,                 /* VIRTUAL  */
    VOLATILE = 711,                /* VOLATILE  */
    WHEN = 712,                    /* WHEN  */
    WHERE = 713,                   /* WHERE  */
    WHITESPACE_P = 714,            /* WHITESPACE_P  */
    WINDOW = 715,                  /* WINDOW  */
    WITH = 716,                    /* WITH  */
    WITHIN = 717,                  /* WITHIN  */
    WITHOUT = 718,                 /* WITHOUT  */
    ...
    WRITE_P = 721,                 /* WRITE_P  */
    XML_P = 722,                   /* XML_P  */
    XMLATTRIBUTES = 723,           /* XMLATTRIBUTES  */
    XMLCONCAT = 724,               /* XMLCONCAT  */
    XMLELEMENT = 725,              /* XMLELEMENT  */
    XMLEXISTS = 726,               /* XMLEXISTS  */
    XMLFOREST = 727,               /* XMLFOREST  */
    XMLNAMESPACES = 728,           /* XMLNAMESPACES  */
    XMLPARSE = 729,                /* XMLPARSE  */
    XMLPI = 730,                   /* XMLPI  */
    XMLROOT = 731,                 /* XMLROOT  */
    XMLSERIALIZE = 732,            /* XMLSERIALIZE  */
    XMLTABLE = 733,                /* XMLTABLE  */
    YEAR_P = 734,                  /* YEAR_P  */
    YEARS_P = 735,                 /* YEARS_P  */
    YES_P = 736,                   /* YES_P  */
    ZONE = 737,                    /* ZONE  */
    NOT_LA = 738,                  /* NOT_LA  */
    NULLS_LA = 739,                /* NULLS_LA  */
    WITH_LA = 740,                 /* WITH_LA  */
    POSTFIXOP = 741,               /* POSTFIXOP  */
    UMINUS = 742                   /* UMINUS  */
  };
...
#line 596 "third_party/libpg_query/grammar/grammar_out.hpp"
